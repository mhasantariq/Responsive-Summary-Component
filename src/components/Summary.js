  ...
  return (
    <div className="summary">
      <div className="summary-results">
        <p>Your Result</p>
        <div className="summary-results-circle">
          <div className="summary-results-score ">76</div>
          <p>of 100</p>
        </div>
        <p className="fw-bold ">Great</p>
        <p className="summary-results-details">
          You scored higher than 65% of the people who have taken these tests.
        </p>
      </div>
      <div className="summary-score">
        <p className="fw-bold">Summary</p>
        <div className="summary-score-stats">
          <div className="summary-score-results summary-score-results--red">
            <div>
              <svg
            ...
            <div>
              <span className="fw-bold">80</span> / 100
            </div>
          </div>
          <div className="summary-score-results summary-score-results--yellow">
            <div>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="20"
            ...
            <div>
              <span className="fw-bold">92</span> / 100
            </div>
          </div>
          <div className="summary-score-results summary-score-results--green">
            <div>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="20"
            ...
            <div>
              <span className="fw-bold">61</span> / 100
            </div>
          </div>

          <div className="summary-score-results summary-score-results--purple">
            <div>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="20"
            ...
            <div>
              <span className="fw-bold ">70</span> / 100
            </div>
          </div>
        </div>
        <button className="btn btn-blue btn-lg col-12 rounded-pill">
          Continue
        </button>
      </div>
    </div>
